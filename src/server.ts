...
// Create a server instance that can handle per-user iphone devices
export function createServerForUser() {
  return createServer();
}
...
export async function startMcpServer(): Promise<void> {
  try {
    ...
    console.info("Flutter-Check-Design MCP Server connected via stdio");
  } catch (error) {
